...
for root, dirs, files in os.walk('../network'):
    ...
    for d in dirs:
        shutil.rmtree(os.path.join(root, d))        
get_all_images_in_folder("/home.ORIG/npochhi/buildings_bing/single_buildings/","/home.ORIG/npochhi/buildings_vaihingen/buildings/")
'''
Replace the path in the above method call with path to  Bing_Huts_Dataset/single_buildings/ folder, Vaihingen_Building_Dataset/buildings/ folder
'''